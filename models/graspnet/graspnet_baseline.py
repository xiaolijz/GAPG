...
class GraspNetBaseLine():
    def __init__(self, checkpoint_path, num_point=20000, num_view=300, collision_thresh=0.01, empty_thresh = 0.15,voxel_size=0.01):
    ...
    def collision_detection(self,gg, cloud):
        ...
        # collision_mask = mfcdetector.detect(gg, approach_dist=0.075, collision_thresh=self.collision_thresh)
