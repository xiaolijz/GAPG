...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default='push_data/data_M5/save_models/push_model_v2.pt')
    parser.add_argument('--global_ply_dir', type=str, default='push_data/data_M5/global_npy')
    parser.add_argument('--pose_txt', type=str, default='push_data/data_M5/merge_push_actions.txt')
    parser.add_argument('--label_txt', type=str, default='push_data/data_M5/merge_labels_update.txt')
